          ...
          <Slider {...settings} className="testimonials-list Carousel">
            <li>
              <div className="testimonials-list-content">
                ...
                <p>
                  Sed semper, risus eget laoreet dictum, neques velit gravida
                  nunc, id eleifend er.
                </p>
              </div>
            </li>
            ...
            <li className="pager">
              <div className="testimonials-list-content">
                ...
                <p>
                  Nulla lacinia volutpat dignissim. Curabit cursus lobortis
                  consectetur. Maurisase.
                </p>
              </div>
            </li>
            ...
            <li className="pager">
              <div className="testimonials-list-content">
                ...
                <p>
                  Quisque semper congue elit eu aliquam. Aenean dolor mi,
                  gravida eget fermente.
                </p>
              </div>
            </li>
            ...
            <li className="pager">
              <div className="testimonials-list-content">
                ...
                <p>
                  Suspendisse sit amet nisi est. Ut id eros tortorad blandit
                  tincidunt. Vel su.
                </p>
              </div>
            </li>
